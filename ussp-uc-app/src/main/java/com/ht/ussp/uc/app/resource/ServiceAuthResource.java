...
public class ServiceAuthResource {
    ...
    public PageResult  listCalledService(PageVo page) {
       ...
       // return htBoaInServiceCallService.findAllByPage(new PageRequest(page.getPage(), page.getLimit()),page.getQuery());
    	 return htBoaInServiceCallService.findAllByPage2(pageConf,page.getQuery());
    }
	...
	public Result add(@RequestBody HtBoaInServiceCall htBoaInServiceCall, @RequestHeader("userId") String userId) {
		...
		u.setCallService(htBoaInServiceCall.getCallService());
    ...
    public PageResult  listServiceAPI(PageVo page) {
    	...
    	pageConf.setSize(page.getLimit());
    	pageConf.setSearch(page.getKeyWord());
        return htBoaInServiceApiService.findAllByPage(new PageRequest(page.getPage(), page.getLimit()),page.getQuery(),page.getKeyWord());
    }
	...
	@SuppressWarnings({   "rawtypes" })
	@ApiOperation(value = "禁用/启用微服务API", notes = "禁用/启用微服务")
