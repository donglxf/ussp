...
public interface HtBoaInRoleRepository
    ...
    @Query("SELECT new com.ht.ussp.uc.app.model.BoaInRoleInfo(u.roleCode, u.roleName, u.roleNameCn,  u.status, u.createOperator, u.createdDatetime, u.updateOperator, u.lastModifiedDatetime,u.delFlag,u.id) FROM HtBoaInRole u    WHERE  (u.roleCode LIKE ?1 OR u.roleName LIKE ?1 OR u.roleNameCn LIKE ?1    ) AND u.delFlag=0 GROUP BY u")
    public Page<BoaInRoleInfo> listRoleInfoByPageWeb(Pageable arg0, String search);
