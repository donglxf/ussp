...
public interface HtBoaInPositionRepository
    ...
    @Query("SELECT new com.ht.ussp.uc.app.model.BoaInPositionInfo (u.id,u.positionCode, u.positionName, u.positionNameCn, o0.orgCode, o0.orgName, o0.orgNameCn, o0.orgType,  o1.orgCode, o1.orgName, o1.orgNameCn, o1.orgType,  u.orgPath, u.sequence, u.createOperator, u.createdDatetime, u.updateOperator, u.lastModifiedDatetime,u.delFlag,u.status) FROM HtBoaInPosition u, HtBoaInOrg o0, HtBoaInOrg o1   WHERE u.parentOrgCode = o0.orgCode AND u.rootOrgCode = o1.orgCode  AND ( u.positionCode LIKE ?1 OR u.positionName LIKE ?1 OR u.positionNameCn LIKE ?1 ) AND u.orgPath like ?2 AND u.delFlag=0  GROUP BY u")
