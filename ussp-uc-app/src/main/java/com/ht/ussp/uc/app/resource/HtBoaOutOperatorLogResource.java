...
import com.ht.ussp.uc.app.service.HtBoaOutOperatorLogService;
import io.swagger.annotations.ApiImplicitParam;
import io.swagger.annotations.ApiOperation;

/**
 * 
 * @ClassName: HtBoaOutOperatorLogResource
 * @Description: 操作日志信息
...
public class HtBoaOutOperatorLogResource {

    private static final Logger log = LoggerFactory
            .getLogger(HtBoaOutOperatorLogResource.class);

    @Autowired
    private HtBoaOutOperatorLogService htBoaOutOperatorLogService;
    
    @ApiOperation(value = "对外：操作日志查询", notes = "列出所有操作日志列表信息")
